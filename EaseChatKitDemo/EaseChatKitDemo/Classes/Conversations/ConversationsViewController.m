...
- (void)viewDidLoad {
    ...
    viewMdeol.badgeLabelPosition = EaseAvatarTopRight;
...
- (id<EaseUserProfile>)easeUserDelegateAtConversationId:(NSString *)conversationId
                                        conversationType:(AgoraChatConversationType)type
{
    DemoUserProfile *model = [[DemoUserProfile alloc] initWithEaseId:conversationId];
    return model;
}

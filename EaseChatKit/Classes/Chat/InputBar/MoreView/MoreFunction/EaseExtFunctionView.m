...
@property (nonatomic, strong) EaseExtFuncViewModel *extFuncMode;
@end
...
@interface EaseExtFunctionView()<UICollectionViewDataSource,SessionToolbarCellDelegate>
{
...
@implementation EaseExtFunctionView
